...
public class BEDoubleInputAttributeCategory extends BEBaseInputAttributeCategory
{
    ...
    {
        final Set<BEDoubleInputAttributeCategory> outputSet = new HashSet<>();
        this.values.forEach(value -> {
            final BEDoubleInputAttributeCategory i = new BEDoubleInputAttributeCategory(this.name, this.trackingEnabled);
            i.add(value);
            outputSet.add(i);
        });
        return outputSet;
