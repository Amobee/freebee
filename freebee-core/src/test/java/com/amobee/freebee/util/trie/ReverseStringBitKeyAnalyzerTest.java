 ...
 * @author Michael Bond
 */
public class ReverseStringBitKeyAnalyzerTest
{
    @Test
    public void testFourCharacters() throws Exception
    {
        final ReverseStringBitKeyAnalyzer keyAnalyzer = new ReverseStringBitKeyAnalyzer();
        ...
        // 'm' 00000000 01101101
        assertEquals('m', keyAnalyzer.getElement(key, 0));
        ...
        // 'o' 00000000 01101111
        assertEquals('o', keyAnalyzer.getElement(key, 1));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        ...
        // 'c' 00000000 01100011
        assertEquals('c', keyAnalyzer.getElement(key, 2));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        assertFalse(keyAnalyzer.isBitSet(key, index++));
        assertFalse(keyAnalyzer.isBitSet(key, index++));
    ...
    public void testFiveCharacters() throws Exception
    {
        ...
        // 'c' 00000000 01100011
        assertEquals('c', keyAnalyzer.getElement(key, 0));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        assertFalse(keyAnalyzer.isBitSet(key, index++));
        assertFalse(keyAnalyzer.isBitSet(key, index++));
        ...
        // 'a' 00000000 01100001
        assertEquals('a', keyAnalyzer.getElement(key, 4));
        assertTrue(keyAnalyzer.isBitSet(key, index++));
        assertFalse(keyAnalyzer.isBitSet(key, index++));
        assertFalse(keyAnalyzer.isBitSet(key, index++));
        assertFalse(keyAnalyzer.isBitSet(key, index++));
    ...
    public void testSerialization() throws Exception
    {
        ...
        final ReverseStringBitKeyAnalyzer deserializedReverseStringBitKeyAnalyzer  = (ReverseStringBitKeyAnalyzer) objectInputStream.readObject();
